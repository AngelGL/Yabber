...
$menemojis = array(
			...
			'gaydude' => 'gaydude.gif',
			'psoe' => 'PSOE.png',
			'ciudadanos' => 'Ciudadanos.png',
			'populares' => 'PartidoPopular.png',
			'podemos' => 'PODEMOS.png',
			'izqUnida' => 'IzquierdaUnida.png',
			'upyd' => 'UPYD.png',
	);
...
echo '<li><a href="#" data-target="cat-meneame" class="emoji-tab active">titulares</a></li>';
