...
class League {
	...
	public function get_pages($per_page=16)
	{
		global $db;
		...
		return $db->get_results("SELECT id FROM " . Match::TABLE . " WHERE league_id = $this->id ORDER BY date ASC LIMIT {$current}, $per_page");
	}
