...
do_header(_("plataformas"), 'plataformas');
...
function print_tabs($option) {
	...
	if ($current_user->user_id) {
    	$items[] = array('id' => 0, 'url' => 'plataformas', 'title' => _('suscripciones'));
	}
    $items[] = array('id' => 1, 'url' => 'plataformas?active', 'title' => _('más activas'));
	$items[] = array('id' => 2, 'url' => 'plataformas?all', 'title' => _('todas'));
	if ($can_edit) {
		$items[] = array('id' => 3, 'url' => 'subedit', 'title' => _('crear plataforma'));
	}
