...
$items = array(_('usuario'),  _('karma'), _('temas iniciados'), _('comentarios'), _('votos últimos 2 meses'));
...
echo '<div class="topheading"><h2>'._('Top de usuarios').'</h2></div>';
...
for($i=0; $i<count($items); $i++) {
	...
	if($i==$sortby) {
	 ...
	 } elseif ($i <= 0 && $i > 0) { // Disabled other options, we need a cached system
