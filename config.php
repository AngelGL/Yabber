...
$globals['time_enabled_comments'] = 31104000; // 365 days
$globals['time_enabled_comments_status']['queued'] = 31104000; // 365 days
...
$globals['time_enabled_votes'] = 31104000; // 365 days
...
$globals['new_user_time'] = 0; // 3 days. Time from registry date the user is considered "new user"
...
$globals['new_user_links_limit'] = 20; //links allowed to submit in interval for new users
$globals['new_user_links_interval'] = 0;
$globals['user_links_limit'] = 30;
$globals['user_links_interval'] = 0;
$globals['user_links_clon_interval'] = 0; // hours forbidden to send with a clone, 0 to allow it
...
$globals['draft_limit'] = 7; // Max unset drafts at the same time
...
$globals['css_webfonts'] = "//fonts.googleapis.com/css?family=Roboto:400|Righteous|Poiret+One";
...
$globals['enabled_tags'] = 'b|i|u|em|strong|del|sup|sub|spoiler|hr|h1|h2|h3'; // HTML tags allowed for comments and posts
